...
<head>
    ...
    <title>Documentos | WTM | Assine seus documentos online</title>
    <!-- Ion icons -->
...
<body>
        ...
        <div class="page-title documents-page" style="overflow:visible;">
            <div class="row">
                <div class="col-md-6 col-xs-6">
                    <h3>Documents</h3>
                    <p class="breadcrumbs text-muted"><span class="home-folder">Início / Pastas</span></p>
                </div>
                <div class="col-md-6 col-xs-6 text-right page-actions">
                    <button href="" class="btn btn-default go-back hidden-xs"><i class="ion-ios-arrow-back"></i> Voltar</button>
                    <button class="btn btn-primary-ish  hidden-xs" data-toggle="modal" data-target="#createFolder" data-backdrop="static" data-keyboard="false"><i class="ion-folder"></i> Criar Pasta</button>
                    <div class="dropdown">
                        <button class="btn btn-primary dropdown-toggle" data-toggle="dropdown"><i class="ion-arrow-down-b"></i> Novo Arquivo </button>
                        <ul class="dropdown-menu" role="menu">
                            <li role="presentation"><a role="menuitem" tabindex="-1" href="javascript:void(0)" data-toggle="modal" data-target="#uploadFile" data-backdrop="static" data-keyboard="false">
                                    <i class="ion-ios-cloud-upload-outline"></i> <span>Upload Arquivo</span></a></li>
                    ...
                    <div class="documents-filter-form">
                        <form>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12">
                                        <label class="radio"><input type="radio" name="status" value="Signed"><span class="outer"><span class="inner"></span></span>Não Assinado</label>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12">
                                        <label class="radio"><input type="radio" name="status" value="Unsigned"><span class="outer"><span class="inner"></span></span>Não Assinado</label>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal fade" id="uploadFile" role="dialog">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="simcy-form"action="<?=url("Document@uploadfile");?>" data-parsley-validate="" loader="true" method="POST">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="simcy-form"action="<?=url("Document@createfolder");?>" data-parsley-validate="" loader="true" method="POST">
                    <div class="modal-body">
                        <p class="text-muted">Use pastas para organizar seus arquivos.</p>
                        <div class="form-group">
                             <div class="row">
                                <div class="col-md-12">
                                    <label>Nome da Pasta</label>
                                    <input type="text" class="form-control" name="name" placeholder="Nome da Pasta" data-parsley-required="true">
                                    <input type="hidden" name="folder" value="1">
                                    <input type="hidden" name="csrf-token" value="<?=csrf_token();?>" />
                                </div>
                            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="simcy-form"action="<?=url("Document@updatefolder");?>" data-parsley-validate="" loader="true" method="POST">
                    <div class="modal-body">
                        <p class="text-muted">Mude o nome de sua Pasta.</p>
                        <div class="form-group">
                             <div class="row">
                                <div class="col-md-12">
                                    <label>Nome da Pasta</label>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="simcy-form"action="<?=url("Document@updatefile");?>" data-parsley-validate="" loader="true" method="POST">
                    <div class="modal-body">
                        <p class="text-muted">Mude o nome de seu arquivo.</p>
                        <div class="form-group">
                             <div class="row">
                                <div class="col-md-12">
                                    <label>Nome do Arquivo</label>
    ...
    <div class="modal fade" id="dropbox" role="dialog">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Importe do Dropbox</h4>
                </div>
                <div class="modal-body">
                    <p class="text-muted">Simplesmente importe arquivos da sua conta do Dropbox. Apenas PDF<?php if(env("ALLOW_NON_PDF") == "Enabled"){ ?>, Word, Excel e Power Point <?php } ?> são permitidos.</p>
    ...
    <div class="modal fade" id="google-drive" role="dialog">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="text-muted">Simplesmente importe arquivos da sua conta do Google Drive. Apenas PDF<?php if(env("ALLOW_NON_PDF") == "Enabled"){ ?>, Word, Excel e Power Point <?php } ?> são permitidos. Verifique também se você possui<a href="https://support.google.com/drive/answer/2494822" target="_blank">ativado o compartilhamento do seu documento</a></p>
                    <div class="dropbox-button-holder">
